    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 text-center">
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Team Overview</h2>
            <p className="text-gray-500">Manager level reports and tasks will be displayed here.</p>
        </div>
      </div>
    </div>
  )
